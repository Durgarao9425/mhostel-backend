...
export const getExpenses = async (req, res) => {
    try {
        ...
        let query = db('expenses as e')
            ...
            .select('e.*', 'h.hostel_name', 'ec.category_name', 'pm.payment_mode_name as payment_mode');
...
export const createExpense = async (req, res) => {
    try {
        const user = req.user;
        const { category_id, expense_date, amount, payment_mode_id, vendor_name, description, bill_number } = req.body;
...
export const getExpenseSummary = async (req, res) => {
    try {
        ...
        let query = db('expenses as e')
            .leftJoin('expense_categories as ec', 'e.category_id', 'ec.category_id')
            .select('ec.category_name', 'ec.category_id')
