 ...
 */
export const getIdProofTypeById = async (req, res) => {
    try {
 ...
 */
export const createIdProofType = async (req, res) => {
    try {
 ...
 */
export const updateIdProofType = async (req, res) => {
    try {
        const { proofTypeId } = req.params;
        ...
        if (regex_pattern !== undefined)
            updateData.regex_pattern = regex_pattern;
 ...
 */
export const deleteIdProofType = async (req, res) => {
    try {
        const { proofTypeId } = req.params;
        // Check if proof type exists
        const proofType = await db('id_proof_types')
...
//# sourceMappingURL=idProofTypesController.js.map