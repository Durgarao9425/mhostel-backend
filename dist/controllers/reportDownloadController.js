...
export const downloadPDFReport = async (req, res) => {
    try {
        ...
        const incomes = await db('income as i')
            ...
            .select('i.income_date', 'i.amount', 'i.source', 'pm.payment_mode_name as payment_mode', 'i.receipt_number', 'i.description')
        ...
        const expenses = await db('expenses as e')
            ...
            .select('e.expense_date', 'e.amount', 'ec.category_name', 'pm.payment_mode_name as payment_mode', 'e.bill_number', 'e.vendor_name', 'e.description')
        ...
        for (let i = 0; i < pageCount; i++) {
            ...
            doc.fontSize(8).font('Helvetica').fillColor('#666666')
                .text(`Generated on ${formatDate(new Date().toISOString())} at ${new Date().toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit' })} | Page ${i + 1} of ${pageCount}`, margin, pageHeight - 30, { align: 'center', width: contentWidth });
        }
        doc.end();
    }
    catch (error) {
...
//# sourceMappingURL=reportDownloadController.js.map