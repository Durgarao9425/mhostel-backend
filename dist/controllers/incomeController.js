...
export const getAllIncome = async (req, res) => {
    try {
        ...
        let query = db('income as i')
            ...
            .select('i.income_id', 'i.hostel_id', 'h.hostel_name', 'i.income_date', 'i.amount', 'i.source', 'pm.payment_mode_name as payment_mode', 'i.receipt_number', 'i.description');
...
export const createIncome = async (req, res) => {
    try {
        const user = req.user;
        const { income_date, amount, source, payment_mode_id, receipt_number, description } = req.body;
