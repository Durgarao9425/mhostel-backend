...
const generateMonthlyFeesForHostel = async (hostel_id, fee_month) => {
    try {
        ...
        const students = await db('students as s')
            ...
            .select('s.student_id', 's.hostel_id', 's.monthly_rent');
...
//# sourceMappingURL=monthlyFeesGeneration.js.map